			...
			<ImageBackground source={BackgroundImage} style={styles.imageBackground}>
				...
				<View style={styles.bottomContainerView}>
					...
					<View style={styles.createAccountView}>
						<Link href="/(auth)/recovery" style={{marginBottom: 20}}><MontserratText style={styles.createAccountText}>¿Olvidaste tu</MontserratText> <MontserratSemiText style={styles.createAccountButton}>contraseña?</MontserratSemiText></Link>
