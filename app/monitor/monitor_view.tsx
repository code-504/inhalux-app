...
const MonitorViewPage = () => {
    ...
    const [selectedKindred, setSelectedKindred] = useState<ListItem | string>(
        String(monitor_kindred)
    );
    ...
    const handleSelectItem = async (item: ListItem) => {
        ...
        const { data, error } = await supabase
            .from("user_relations")
            .update({
                name_from_patient: item.text,
                name_from_monitor: patientKindred,
            })
    ...
    return (
        <View style={styles.safeAre}>
                    ...
                    <View style={styles.cardList}>
                        <View style={styles.cardItem}>
                            <View style={styles.cardTextView}>
                                <MontserratText style={styles.cardTitle}>
                                    Parentesco
                                </MontserratText>
                                <MontserratBoldText style={styles.cardText}>
                                    {String(selectedKindred)}
                                </MontserratBoldText>
                            </View>
                            ...
                            <Button
                                ...
                                onPress={() => kindredRef.current?.present()}
                            >
                                <EditIcon />
                            </Button>
                        </View>
            ...
            >
                <MontserratSemiText style={styles.titleSheet}>
