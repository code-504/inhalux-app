...
export default function TabThreeScreen() {
    ...
    const formSchema = z.object({
        addCode: z
            .string()
            .min(36, { message: "El código debe tener 36 carácteres" }),
    });
    ...
    useEffect(() => {
        if (keyboardHook.keyboardShown) monitorListModalRef.current?.expand();
    ...
    return (
        <View style={styles.viewArea}>
                        ...
                        >
                            <SearchList
                                ...
                                noData={{
                                    ...
                                    message:
                                        "Monitorea el inhalador de alguien más de forma rápida y segura",
                                }}
                                ListData={
                                    <BottomSheetFlatList
                        ...
                        >
                            <SearchList
                                ...
                                noData={{
                                    ...
                                    message:
                                        "Comparte la información de tu inhaLux con los que más quieres",
                                }}
                                ListData={
                                    <BottomSheetFlatList
            ...
            >
                <View style={stylesBottom.container}>
                    <View style={stylesBottom.titleContent}>
                        <MontserratSemiText style={stylesBottom.title}>
                            ¿Qué deseas hacer?
                        </MontserratSemiText>
                    </View>
                    ...
                    <View style={{ gap: 16 }}>
                        <Button
                            onPress={() => openShareCodeSheet()}
                            backgroundColor={Colors.lightGrey}
                            size="$6"
                            borderRadius={"$radius.10"}
                        >
                            <ShareIcon />
                            <MontserratSemiText style={{ color: Colors.black }}>
                                Compartir mi Cuenta
                            </MontserratSemiText>
                        </Button>
                        <Button
                            onPress={() => openAddPacientSheet()}
                            backgroundColor={Colors.lightGrey}
                            size="$6"
                            borderRadius={"$radius.10"}
                        >
            ...
            >
                <View style={stylesBottom.container}>
                    <View style={stylesBottom.titleContent}>
                        <MontserratBoldText style={stylesBottom.title}>
                            Agregar paciente usando...
                        </MontserratBoldText>
                    </View>
                    ...
                    <View style={stylesBottom.buttonsView}>
                        ...
                        <View style={stylesBottom.buttonContent}>
                            <Button
                                ...
                                size="$6"
                                onPress={() =>
                                    router.push("/monitor/scan_pacient")
                                }
                            >
                                <QRScannerIcon />
                            </Button>
                    ...
                    >
                        <View style={stylesDialog.content}>
                            <View>
                                ...
                                />
                                {addCodeError != "" && (
                                    <MontserratText style={styles.errorMessage}>
                                        {addCodeError}
                                    </MontserratText>
                                )}
                            </View>
