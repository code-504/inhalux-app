...
export default function TabThreeScreen() {
    ...
    const handleAssignTreatment = async () => {
        ...
        if (supaTreatment === null) {
            ...
            const { data, error } = await supabase
                ...
                .insert([
                    {
                        treatment: { days: daysState, hours: hoursState },
                        fk_user_id: supaUser?.id,
                    },
                ])
                .select();
    ...
    const handleRemoveHour = (hourToRemove: any) => {
        setHoursState((prevHours) =>
            prevHours.filter((hour) => hour !== hourToRemove)
        );
    };
                        ...
                        >
                            <BottomSheetScrollView>
                                <View style={stylesTab.content}>
                                    ...
                                    >
                                        {supaTreatment == null
                                            ? "¡NO cuentas con tratamiento!"
                                            : "Tu tratamiento:"}
                                    </MontserratBoldText>
                                    <MontserratSemiText style={styles.daysTag}>
                                        Días:
                                    </MontserratSemiText>
                                    ...
                                    >
                                        ...
                                        >
                                            <SwitchWithLabel
                                                ...
                                                checked={daysState.includes(2)}
                                            />
                                            <SwitchWithLabel
                                                size="$3"
                                                label="Martes"
                                                handleDayPick={handleDayPick}
                                                checked={daysState.includes(3)}
                                            />
                                        </XStack>
                                        <XStack
                                            space="$1"
                                        ...
                                        >
                                            <SwitchWithLabel
                                                ...
                                                label="Miércoles"
                                                handleDayPick={handleDayPick}
                                                checked={daysState.includes(4)}
                                            />
                                            <SwitchWithLabel
                                                size="$3"
                                                label="Jueves"
                                                handleDayPick={handleDayPick}
                                                checked={daysState.includes(5)}
                                            />
                                        </XStack>
                                        <XStack
                                            space="$1"
                                        ...
                                        >
                                            <SwitchWithLabel
                                                ...
                                                label="Viernes"
                                                handleDayPick={handleDayPick}
                                                checked={daysState.includes(6)}
                                            />
                                            <SwitchWithLabel
                                                size="$3"
                                                label="Sábado"
                                                handleDayPick={handleDayPick}
                                                checked={daysState.includes(7)}
                                            />
                                        </XStack>
                                        <XStack
                                            space="$1"
                                        ...
                                        >
                                            <SwitchWithLabel
                                                ...
                                                label="Domingo"
                                                handleDayPick={handleDayPick}
                                                checked={daysState.includes(1)}
                                            />
                                        </XStack>
                                    </YStack>

                                    <MontserratSemiText style={styles.hoursTag}>
                                        Horas:
                                    </MontserratSemiText>
                                    ...
                                    <Button onPress={handleAssignTreatment}>
                                        {supaTreatment === null
                                            ? "Asignar "
                                            : "Actualizar "}
                                        Tratamiento
                                    ...
                                    {supaTreatment !== null && (
                                        <Button onPress={handleRemoveTreatment}>
