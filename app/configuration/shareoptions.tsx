        ...
        <View style={styles.safeArea}>
            <Stack.Screen
                options={{
                    header: () => (
                        <NormalHeader
                            title="Opciones de compartir cuenta"
            ...
            >
                <View style={styles.upView}>
                    <MontserratSemiText style={styles.title}>
                    ...
                    <OptionsList title="Cuenta">
                        ...
                        >
                            ...
                            <OptionsList.TextView>
                                <OptionsList.ItemText>
                                    Regenerar clave
                                </OptionsList.ItemText>
                                <OptionsList.ItemDescription>
                                    ¿Esta recibiendo solicitudes de personas que
                                    no conoce? Regenere su clave para acabar con
                                    el problema.
                                </OptionsList.ItemDescription>
                            </OptionsList.TextView>
                        </OptionsList.ItemView>
                        ...
                        >
                            ...
                            <OptionsList.TextView>
                                ...
                                <OptionsList.ItemDescription>
                                    Esta opción eliminará TODOS los usuarios a
                                    los que has compartido tu cuenta.
                                </OptionsList.ItemDescription>
                            </OptionsList.TextView>
                        </OptionsList.ItemView>
                    </OptionsList>
                    ...
                    >
                        <View style={stylesDialog.content}>
                            <View>
                                ...
                                <AlertDialog.Description>
                                    ¿Estás seguro de eliminar a los usuarios?
                                </AlertDialog.Description>
                            </View>
