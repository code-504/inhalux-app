...
const ProfilePage = () => {
    ...
    const photoListSnapPoints = useMemo(() => ["22%"], []);
    ...
    const handleUpdateUserName = async () => {
        setSupaUser({
            ...supaUser,
            name: `${userName.trim()} ${userLastName.trim()}`,
        });
    ...
    return (
        <View style={styles.safeArea}>
            ...
            >
                <View
                    style={{ minHeight: Dimensions.get("window").height - 86 }}
                >
                    <View style={styles.upView}>
                        <View style={styles.avatarContent}>
                            <View style={styles.avatarView}>
                                <Animated.Image
                                    source={{ uri: supaUser?.avatar }}
                                    style={{
                                        width: 220,
                                        height: 220,
                                        borderRadius: 1000,
                        ...
                        <View style={styles.inputContainerView}>
                            ...
                            <View style={styles.inputView}>
                                ...
                                <Input
                                    ...
                                    borderWidth={0}
                                    onChange={(e) =>
                                        setUserLastName(e.nativeEvent.text)
                                    }
                            ...
                            <View style={styles.inputView}>
                                <View style={styles.infoContent}>
                                    ...
                                    <MontserratText style={styles.infoText}>
                                        Tu foto, nombre y apellido de perfil
                                        solo podrá ser visto por alguien más si
                                        has decido ser el monitor o paciente.
                                    </MontserratText>
                                </View>
                            </View>
                        </View>
